...
The animated comparison above (`bl_ga` against `bl_bbs`, on synthetic
geometry) is generated by `tools/render_search_animation.py`, which
reproduces from a clean checkout with no map and no scenarios.
